...
#define __PYX_HAVE__SORTT
#define __PYX_HAVE_API__SORTT
/* Early includes */
#include <string.h>
#include <stdio.h>
...
#define __Pyx_MODULE_NAME "SORTT"
extern int __pyx_module_is_main_SORTT;
int __pyx_module_is_main_SORTT = 0;

/* Implementation of 'SORTT' */
...
static PY_LONG_LONG __pyx_f_5SORTT_SORTT(int __pyx_v_KGAS, int __pyx_v_I, double __pyx_v_R2, int __pyx_v_IE, struct __pyx_obj_8Magboltz_Magboltz *__pyx_v_Object) {
  PY_LONG_LONG __pyx_v_ISTEP;
  PY_LONG_LONG __pyx_v_INCR;
  ...
  int __pyx_t_4;
  int __pyx_t_5;
  __Pyx_RefNannySetupContext("SORTT", 0);
 ...
 *     for K in range(12):
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_Object->ISIZE[__pyx_v_KGAS])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyLong_Type)), __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __Pyx_PyInt_As_PY_LONG_LONG(__pyx_t_2); if (unlikely((__pyx_t_3 == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L1_error)
 ...
 */
    __pyx_v_I = (__pyx_v_INCR + __pyx_v_ISTEP);
 ...
 *                 INCR = INCR + ISTEP
 */
    __pyx_t_5 = ((__pyx_v_I <= (__pyx_v_Object->IPLAST[__pyx_v_KGAS])) != 0);
    if (__pyx_t_5) {
 ...
 *         ISTEP = ISTEP / 2
 */
      __pyx_t_5 = (((((__pyx_v_Object->CF[__pyx_v_KGAS])[__pyx_v_IE])[(__pyx_v_I - 1)]) < __pyx_v_R2) != 0);
      if (__pyx_t_5) {
 ...
 * 
 */
        __pyx_v_INCR = (__pyx_v_INCR + __pyx_v_ISTEP);
 ...
 *     return I
 */
    __pyx_v_ISTEP = __Pyx_div_PY_LONG_LONG(__pyx_v_ISTEP, 2);
  }
 ...
 */
  ...
  __Pyx_WriteUnraisable("SORTT.SORTT", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_pymod_exec_SORTT(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_SORTT},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("SORTT", (void (*)(void))__pyx_f_5SORTT_SORTT, "PY_LONG_LONG (int, int, double, int, struct __pyx_obj_8Magboltz_Magboltz *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initSORTT(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initSORTT(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_SORTT(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_SORTT(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_SORTT(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'SORTT' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_SORTT(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("SORTT", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_SORTT) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "SORTT")) {
      if (unlikely(PyDict_SetItemString(modules, "SORTT", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init SORTT", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init SORTT");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
